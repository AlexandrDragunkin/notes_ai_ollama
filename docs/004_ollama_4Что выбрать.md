...
:::{note}
Какую модель для локального использования посоветовать? если использовать в VScode расширении roo code assistant c провайдером ollama? что посоветуешь? на ноутбуке с характеристиками 
